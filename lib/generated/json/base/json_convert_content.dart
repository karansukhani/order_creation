...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<CustomerListEntity>[] is M) {
      return data.map<CustomerListEntity>((Map<String, dynamic> e) => CustomerListEntity.fromJson(e)).toList() as M;
    }
    if (<CustomerListGetCustomersResult>[] is M) {
      return data
          .map<CustomerListGetCustomersResult>((Map<String, dynamic> e) => CustomerListGetCustomersResult.fromJson(e))
          .toList() as M;
    }
    if (<ProductListEntity>[] is M) {
      return data.map<ProductListEntity>((Map<String, dynamic> e) => ProductListEntity.fromJson(e)).toList() as M;
    }
    if (<ProductListGetProductsResult>[] is M) {
      return data
          .map<ProductListGetProductsResult>((Map<String, dynamic> e) => ProductListGetProductsResult.fromJson(e))
          .toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (CustomerListEntity).toString(): CustomerListEntity.fromJson,
    (CustomerListGetCustomersResult).toString(): CustomerListGetCustomersResult.fromJson,
    (ProductListEntity).toString(): ProductListEntity.fromJson,
    (ProductListGetProductsResult).toString(): ProductListGetProductsResult.fromJson,
  };
